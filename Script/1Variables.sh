...
# export KV_USER_ASSIGNED_CLIENT_ID="a61dc021-b0c5-4118-8928-03b13c14d8a4"
...
# # These two variables are just for reference to use the value otherwise they will be created as secret during KeyVault creation and will use from there only - no direct propagation
# MYSQL_ADMIN_USERNAME="developer"
# MYSQL_ADMIN_PW="webops_mysqlpw"
# WP_ADMIN_USERNAME="adminwebops"
# WP_ADMIN_PASSWORD="webops_wppw"
...
# export SSL_EMAIL_ADDRESS="$(az account show --query user.name --output tsv)"
# export SUBSCRIPTION_ID="$(az account show --query id --output tsv)"
# export WEBSITE_NAME="v1997.tech"
# export MY_RESOURCE_GROUP_NAME="RGAZWebopsProj8"
# export REGION="canadacentral"
...
# # Key Vault
# export KEY_VAULT_NAME="ptlWebOpsKeyVaultproj8"
# export UAMI="azurekeyvaultsecretsprovider-${MY_AKS_CLUSTER_NAME}"
...
# ###### ACR ######
# export ACR_NAME="ptlwebopsacrproj8"
# export DOCKER_HUB_IMAGE_NAME="unaveed1122/project8wp:v1"

# ###### Azure MySQL #####
# export MY_DNS_ZONE_NAME="v1997.tech"
# export MYSQL_SERVER_NAME="ptlmysqlwpsrvrproj8"
# export MYSQL_HOSTNAME="${MYSQL_SERVER_NAME}.mysql.database.azure.com"
# export MYSQL_DB_NAME="webopswordpressdb"
# export WP_TITLE="uShipiDeliver by WebOps"
# export WORDPRESS_EMAIL="ushipideliver@hotmail.com"
